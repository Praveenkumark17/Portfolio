        ...
        <div className="container">
          ...
          <div className={`${home_style.connect}`}>
            ...
            <div className="text-center mt-4">
              <button className={`${theme?home_style.connect_icon_dark:home_style.connect_icon}`}><a href="http://www.instagram.com" className="d-flex justify-content-center"><i className="fa-brands fa-instagram"></i></a></button>
              ...
              <button className={`${theme?home_style.connect_icon_dark:home_style.connect_icon} ms-3`}><a href="http://www.linkedin.com" className="d-flex justify-content-center"><i className="fa-brands fa-linkedin-in"></i></a></button>
            </div>
          </div>
        </div>
      </div>
